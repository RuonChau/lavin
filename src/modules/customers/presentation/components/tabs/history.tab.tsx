  ...
  return (
    <GlassCard className="p-8" radius="4xl">
      ...
      <div className="space-y-4">
        {history.map(item => (
          <div key={item.id} className="flex flex-col md:flex-row md:items-center justify-between p-5 bg-white/40 border border-primary-soft/20 hover:border-primary/30 rounded-3xl shadow-sm transition-all group cursor-pointer">
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="font-bold text-text-primary text-base group-hover:text-primary transition-colors">{item.customer}</p>
                <div className="flex items-center gap-3 mt-1.5">
                  ...
                  <span className="text-[11px] font-bold text-text-muted">{item.date}</span>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-8 mt-4 md:mt-0">
              <div className="text-right">
                ...
                <p className="font-bold text-text-primary">{item.items} món</p>
              </div>
              <div className="text-right">
              ...
              <div className="text-right">
                ...
                <p className="font-black text-text-primary tag-green bg-green-50 px-2 py-1 rounded-lg">+{item.pointsEarned}</p>
              </div>
            </div>
          </div>
        ))}
