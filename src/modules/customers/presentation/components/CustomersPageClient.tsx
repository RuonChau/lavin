          ...
          >
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item
                  name="name"
                  label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Họ và tên</span>}
              ...
              <Col span={12}>
                <Form.Item
                  name="phone"
                  label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Số điện thoại</span>}
                  rules={[{ required: true, message: 'Vui lòng nhập số điện thoại' }]}
                >
                  <Input placeholder="0901234567" className="h-12 rounded-xl bg-white/60 border-primary-soft/30 hover:border-primary/50 focus:border-primary/50 shadow-sm" />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Row gutter={24}>
              <Col span={12}>
                <Form.Item
                  name="email"
                  label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Email</span>}
                >
                  <Input placeholder="nva@example.com" className="h-12 rounded-xl bg-white/60 border-primary-soft/30 hover:border-primary/50 focus:border-primary/50 shadow-sm" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item
                  name="dob"
                  label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Ngày sinh</span>}
                >
                  <DatePicker format="DD/MM/YYYY" placeholder="Chọn ngày sinh" className="w-full h-12 rounded-xl bg-white/60 border-primary-soft/30 hover:border-primary/50 focus:border-primary/50 shadow-sm" classNames={{ popup: '!rounded-2xl' }} />
                </Form.Item>
              </Col>
            </Row>
            ...
            <Form.Item
              name="address"
              label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Địa chỉ</span>}
            >
              <Input placeholder="Địa chỉ giao hàng mặc định" className="h-12 rounded-xl bg-white/60 border-primary-soft/30 hover:border-primary/50 focus:border-primary/50 shadow-sm" />
            </Form.Item>

            <Form.Item
              name="note"
              label={<span className="text-[10px] font-black text-primary-soft uppercase tracking-[0.2em]">Ghi chú (Sở thích/Lưu ý)</span>}
            >
              <Input.TextArea rows={2} placeholder="Thường uống cafe ít sữa, ít đá..." className="rounded-xl bg-white/60 border-primary-soft/30 hover:border-primary/50 focus:border-primary/50 shadow-sm py-3" />
            </Form.Item>
            ...
            <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-primary-soft/10">
              <button
                ...
                className="px-6 py-3.5 bg-white border border-primary-soft/30 hover:bg-bg-soft text-text-secondary rounded-2xl text-[10px] font-black uppercase tracking-wider transition-all shadow-sm"
              >
                Hủy
              </button>
              <button
