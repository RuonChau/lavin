...
export default function CreatePurchaseOrderModal({ isOpen, onClose }: CreatePurchaseOrderModalProps) {
  ...
  const handleAddMaterial = (material: Material) => {
    ...
    setSelectedItems([...selectedItems, { material, quantity: 1, price: 0 }]);
    setIsMaterialPickerOpen(false);
  };
          ...
          <GlassCard className="overflow-hidden" radius="4xl">
            <div className="p-8 border-b border-[#D8B894]/20 bg-white/60 flex items-center justify-between">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h2 className="text-2xl font-black text-[#2A1E17]">Tạo Đơn nhập hàng</h2>
                  <p className="text-xs text-[#9A8677] font-bold uppercase tracking-widest mt-1">Khởi tạo phiếu nhập kho mới</p>
                </div>
              </div>
            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6 bg-white/40">
               <div className="space-y-4">
                  <div className="space-y-2">
                     ...
                     <select className="w-full bg-white/60 border border-[#D8B894]/20 rounded-2xl py-4 px-6 text-sm font-bold focus:outline-none appearance-none cursor-pointer">
                  ...
                  <div className="space-y-2">
                     ...
                     <input type="date" className="w-full bg-white/60 border border-[#D8B894]/20 rounded-2xl py-4 px-6 text-sm font-bold" />
                  </div>
               </div>
            ...
            <div className="p-8 border-t border-[#D8B894]/20 bg-white/40 flex items-center justify-between">
               <div className="flex flex-col">
                  <p className="text-[10px] font-black text-[#9A8677] uppercase tracking-widest">Tổng giá trị tạm tính</p>
               ...
               <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    className="px-10 py-4 rounded-2xl bg-primary text-white text-sm font-black shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed"
                  >
                    Tạo đơn hàng
                  </button>
               </div>
