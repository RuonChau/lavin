      ...
      <GlassCard className="relative overflow-hidden flex flex-col max-h-[90vh]" radius="4xl">
        ...
        <div className="p-6 border-b border-primary-soft/20 bg-white/40 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-md border border-white shrink-0">
              <img
            ...
            <div>
              <h2 className="text-xl font-bold text-text-primary">{formula.productName}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-0 flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-8 space-y-6">
            ...
            <div className="overflow-hidden rounded-3xl border border-primary-soft/20 bg-white/40">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#FFFAF4]/80 text-text-muted text-[10px] font-bold uppercase tracking-widest border-b border-primary-soft/10">
                  ...
                  {formula.ingredients.map((ing, idx) => (
                    <tr key={idx} className="group hover:bg-white/30 transition-colors">
                      <td className="py-4 px-6">
                        <span className="text-sm font-bold text-text-primary">{ing.materialName}</span>
                      </td>
                      ...
                      <td className="py-4 px-4 text-center text-xs font-bold text-text-muted">
                        {ing.unit}
                      </td>
                      <td className="py-4 px-6 text-right">
                        <span className="text-sm font-bold text-text-primary">₫{ing.cost.toLocaleString('vi-VN')}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="w-full lg:w-80 bg-[#FFFAF4]/60 border-l border-primary-soft/20 p-8 space-y-8">
            <div>
              <h3 className="text-[11px] font-bold text-text-muted uppercase tracking-widest mb-4">Tổng chi phí (BOM)</h3>
              <div className="p-6 rounded-4xl bg-white shadow-sm border border-primary-soft/20 flex flex-col items-center text-center">
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Prime Cost / Cup</p>
            ...
            <div className="space-y-4">
              <h3 className="text-[11px] font-bold text-text-muted uppercase tracking-widest">Hiệu năng kinh doanh</h3>
              <div className="space-y-3">
                <div className="p-4 rounded-2xl bg-white/60 border border-primary-soft/10 flex items-center justify-between">
                  <span className="text-xs text-text-secondary">Giá bán đề xuất</span>
                  <span className="text-sm font-bold text-text-primary">₫55.000</span>
                </div>
                <div className="p-4 rounded-2xl bg-white/60 border border-primary-soft/10 flex items-center justify-between">
                  <span className="text-xs text-text-secondary">Lợi nhuận gộp</span>
            ...
            <div className="space-y-4">
              <h3 className="text-[11px] font-bold text-text-muted uppercase tracking-widest">Lịch sử thay đổi</h3>
              <div className="relative pl-6 space-y-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-px before:bg-primary-soft/30">
                <div className="relative">
                  ...
                  <p className="text-[11px] font-bold text-text-primary">Thêm bột béo (10g)</p>
                  <p className="text-[9px] text-text-muted">12/05/2024 • Admin</p>
                </div>
                <div className="relative">
                  <div className="absolute left-[-1.65rem] top-1 w-3 h-3 rounded-full bg-primary-soft border-2 border-white shadow-sm" />
                  <p className="text-[11px] font-bold text-text-primary">Khởi tạo công thức</p>
                  <p className="text-[9px] text-text-muted">01/05/2024 • System</p>
                </div>
              </div>
            </div>
          </div>
