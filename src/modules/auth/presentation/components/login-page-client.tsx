      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-2">
          ...
          <input
            ...
            className={`w-full glass-control rounded-2xl py-3.5 px-4 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-sm shadow-sm placeholder:text-text-muted/50 ${errors.username ? 'border-red-400' : ''}`}
          />
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            type="password"
            placeholder="••••••••"
            className={`w-full glass-control rounded-2xl py-3.5 px-4 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all text-sm shadow-sm placeholder:text-text-muted/50 ${errors.password ? 'border-red-400' : ''}`}
          />
        ...
        <div className="flex items-center justify-between text-xs py-1">
          <label className="flex items-center gap-2 text-text-secondary cursor-pointer">
            <input type="checkbox" className="rounded-md border-primary-soft/40 text-primary focus:ring-primary/20 bg-white/50" />
