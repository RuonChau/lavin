...
export function MaterialSelectionModal({
  ...
  return (
    <AntdModalShell open={isOpen} onClose={onClose} width={512} zIndex={2000}>
      <GlassCard className="relative overflow-hidden flex flex-col max-h-[70vh]" radius="4xl">
        {/* Header */}
        <div className="p-6 border-b border-primary-soft/20 bg-white/40">
          ...
          <div className="relative group">
            ...
            <input
              ...
              autoFocus
              className="w-full pl-11 pr-5 py-3 rounded-2xl bg-white/40 border border-primary-soft/20 text-sm focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all"
            />
          </div>
        </div>
          ...
          <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[10px] text-text-muted font-bold">{material.sku} • {material.unit}</p>
                  </div>
                </div>
            ...
            {filteredMaterials.length === 0 && (
              <div className="py-12 text-center">
                <Package size={40} className="mx-auto text-text-muted opacity-20 mb-3" />
                <p className="text-sm font-bold text-text-muted">Không tìm thấy nguyên liệu nào</p>
              </div>
            )}
          </div>
        </div>
