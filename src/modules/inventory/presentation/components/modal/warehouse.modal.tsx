  ...
  return (
    <AntdModalShell open={isOpen} onClose={onClose} width={576} zIndex={1500}>
      <GlassCard className="relative overflow-hidden" radius="4xl">
        {/* Header */}
        <div className="p-8 border-b border-primary-soft/20 bg-white/40 flex items-center justify-between">
        ...
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Warehouse className="absolute left-4 top-1/2 -translate-y-1/2 text-primary-soft group-focus-within:text-primary transition-colors" size={18} />
                <input
                  type="text"
                  placeholder="VD: Kho tổng A"
                  className="w-full bg-[#FFFAF4]/40 border border-primary-soft/20 rounded-2xl py-3.5 pl-12 pr-4 text-sm font-bold text-text-primary focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all"
                  value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-[#FFFAF4]/40 border border-primary-soft/20 rounded-2xl py-3.5 px-4 text-sm font-bold text-text-primary focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all uppercase"
                value={formData.code}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    formData.type === type.id
                      ...
                      : "bg-white border-primary-soft/20 text-text-secondary hover:bg-white hover:border-primary-soft/40"
                  )}
                >
                  <type.icon size={20} />
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-primary-soft group-focus-within:text-primary transition-colors" size={18} />
                <input
                  type="text"
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 text-primary-soft group-focus-within:text-primary transition-colors" size={18} />
                  <input
                    type="text"
              ...
              <div className="space-y-2">
                ...
                <input
                  type="number"
                  placeholder="VD: 1000"
                  className="w-full bg-[#FFFAF4]/40 border border-primary-soft/20 rounded-2xl py-3.5 px-4 text-sm font-bold text-text-primary focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all"
        ...
        {/* Footer */}
        <div className="p-8 border-t border-primary-soft/20 bg-[#FFFAF4]/40 flex gap-4">
          <button onClick={onClose}
            className="flex-1 py-4 rounded-2xl bg-white border border-primary-soft/30 text-sm font-bold text-text-secondary transition-all hover:shadow-md"
          >
            Hủy bỏ
          </button>
